                ...
                {chatData.map((item, key) => (
                  <Link to="#" className="d-flex align-items-center" key={key}>
                    ...
                    <div
                      ...
                      onClick={() => chatBox("block", setInfo(item))}
                    >
                    ...
                    >
                      ...
                      >
                        <Link to="#" className="subject">
                          ...
                          {item.badge ? (
                            <span
                              className={"badge me-2 bg-" + item.badgeClass}
                            >
                              {item.badge}
                            </span>
                          ) : null}{" "}
            ...
            <Row>
              ...
              <Col className="col-auto">
                <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                  <button
                    type="button"
                    className="btn btn-ghost-secondary btn-icon btn-sm fs-16 favourite-btn active"
                  >
                    <Rating
                      stop={1}
